...
DB_CONTAINER_NAME="hack_violet_24-mysql"
...
docker run --name $DB_CONTAINER_NAME -e MYSQL_ROOT_PASSWORD=$DB_PASSWORD -e MYSQL_DATABASE=hack_violet_24 -d -p 3306:3306 docker.io/mysql
